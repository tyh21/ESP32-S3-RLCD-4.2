...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_label_5, 200, 21);
    ...
    lv_obj_set_size(ui->screen_label_9, 360, 120);
    ...
    //lv_obj_set_pos(ui->screen_label_13, 20, 150);      // 调整到合适位置（避免覆盖其他控件）
    lv_obj_set_pos(ui->screen_label_13, 260, 92);
    lv_obj_set_size(ui->screen_label_13, 360, 120);    // 足够显示4~5行文字
