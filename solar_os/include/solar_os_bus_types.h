...
#define SOLAR_OS_BUS_SPI_CS_MAX 5
#define SOLAR_OS_BUS_I2C_DEFAULT_SPEED_HZ 100000U
#define SOLAR_OS_BUS_I2C_MAX_SPEED_HZ 1000000U
...
#define SOLAR_OS_BUS_MIDI_DEFAULT_BAUD_RATE 31250U
...
typedef enum {
    ...
    /* User-facing MIDI bus profile backed by the UART service. */
